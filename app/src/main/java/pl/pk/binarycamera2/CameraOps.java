...
public class CameraOps {
     ...
     */
    CameraOps(CameraManager manager, CameraReadyListener readyListener, Handler readyHandler) {
    ...
    private void startCameraSession() {
        ...
        try {
            mCameraDevice.createCaptureSession(mSurfaces, mCameraSessionListener, mCameraHandler);
        } catch (CameraAccessException e) {
            Log.e(TAG, "", e);
            mCameraDevice.close();
            mCameraDevice = null;
    ...
    private CameraDevice.StateCallback mCameraDeviceListener = new CameraDevice.StateCallback() {
        ...
        public void onDisconnected(@NonNull CameraDevice camera) {
            Log.e(TAG, "The camera device has been disconnected.");
            camera.close();
            mCameraDevice = null;
        }
        ...
        public void onError(@NonNull CameraDevice camera, int error) {
            Log.e(TAG, "The camera encountered an error:" + error);
            camera.close();
            mCameraDevice = null;
        }
